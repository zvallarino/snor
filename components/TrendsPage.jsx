  ...
  return (
    <div className="flex flex-col h-full w-full ">
      ...
      <div className="flex w-full justify-between p-4">
        ...
        <div className=" ml-2 text-gray-700">Welcome to our data repository. This page serves as a comprehensive resource for accessing raw datasets, analyzing data trends, and consulting the original sources from which the data was obtained.</div>
      </div>
      ...
      <  div className="flex w-full">PLACE GRAPHS HERE</div>
